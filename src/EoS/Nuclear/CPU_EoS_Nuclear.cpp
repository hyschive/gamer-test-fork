...
// invoke the nuclear EoS driver
   nuc_eos_C_short( Dens_CGS, &Temp_MeV, Ye, &sEint_CGS, &Entr, &Pres_CGS, &Useless, &Useless,
                    EnergyShift, NRho, NTemp, NYe, NRho_Mode, NMode, NYe_Mode,
                    Table[NUC_TAB_ALL], Table[NUC_TAB_ALL_MODE], Table[NUC_TAB_RHO], Table[NUC_TAB_TEMP], Table[NUC_TAB_YE], 
                    Table[NUC_TAB_RHO_MODE], Table[NUC_TAB_ENGY_MODE], Table[NUC_TAB_ENTR_MODE],  Table[NUC_TAB_PRES_MODE],
                    Table[NUC_TAB_RHO_MODE], Mode, &Err, Tolerance );
