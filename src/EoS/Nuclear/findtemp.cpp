...
// determine spacing parameters of equidistant (!!!) table
   ...
   int iv;
   if      ( keymode == 1 ) iv = 0; // energy table for the energy mode
...
// set up coeffs of interpolation polynomical and evaluate function values
   ...
   *found_lt = a[0] + a[1] * delx
   ...
   if ( isnan(*found_lt) || !( *found_lt>logtemp[0] && *found_lt<logtemp[ntemp-1] ) )
   {
      *keyerr = 668;
   }
